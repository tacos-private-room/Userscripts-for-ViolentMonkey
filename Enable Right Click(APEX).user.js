...
// @name              Enable Right Click(APEX)
// @name:en           Enable Right Click(APEX)
// @name:zh           Enable Right Click(APEX)
// @name:zh-CN        Enable Right Click(APEX)
// @name:zh-TW        Enable Right Click(APEX)
// @name:ja           Enable Right Click(APEX)

// @description       Right Click APEX
// @description:en    Right Click APEX
// @description:zh    Right Click APEX
// @description:zh-CN Right Click APEX
// @description:zh-TW Right Click APEX
// @description:ja    Right Click APEX

// @homepageURL       https://hentaigasm.com/
// @supportURL        https://hentaihaven.org/
