...
(function()
{
	...
	gm_extensions.GM_updateCheck("http://userscripts.org/scripts/source/105153.meta.js", version, 10, handle_update_function, unique_script_name);
        ...
        var getCroppedDomain = function () {
            if (!settings.croppedDomain) settings.croppedDomain = utils.cropDomain(getUrlInfo().host);
            return settings.croppedDomain
        };
        var getUrlInfo = function () {
            if (!settings.urlInfo) settings.urlInfo = utils.getUrl(document.location);
        ...
        var sendGetRequest = function (path, async) {
            ...
            if (xmlhttp.readyState == 4)
                if (xmlhttp.status != 200) throw xmlhttp.statusText;
...
function GM_getResourceText(resourceName) {
        ...
        function GM_getResourceURL(resourceName) {
            ...
            if (typeof result === "undefined") throw "Resource " + resourceName + " not found";
            return result
        }
